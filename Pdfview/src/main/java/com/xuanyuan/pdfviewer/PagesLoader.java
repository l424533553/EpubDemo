 ...
 */
package com.xuanyuan.pdfviewer;
...
import static com.xuanyuan.pdfviewer.util.Constants.Cache.CACHE_SIZE;
import static com.xuanyuan.pdfviewer.util.Constants.PRELOAD_OFFSET;
        ...
        for (int page = firstPage; page <= lastPage; page++) {
            ...
            if (page == firstPage) {
                ...
                if (pageCount == 1) {
                    ...
                    com.shockwave.pdfium.util.SizeF pageSize = pdfView.pdfFile.getScaledPageSize(page, pdfView.getZoom());
